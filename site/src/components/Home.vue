<template>
  <div>
    ...
    <p>
      ...
      The API has been setup with a Cognito Authorizer, as per
      <a
        href="http://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-integrate-with-cognito.html#apigateway-enable-cognito-user-pool"
        target="_blank"
        >this guide</a
      >.
    </p>
